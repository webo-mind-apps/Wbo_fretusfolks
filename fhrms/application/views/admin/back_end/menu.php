			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							<a href="<?php echo site_url('pip_letter/');?>" target="_blank" class="nav-link <?php //if($active_menu=="pip") { echo "active"; } ?>"><i class="icon-stack2"></i> <span>PIP Letter</span></a>
						</li>
						<li class="nav-item nav-item-submenu">
						...
						<li class="nav-item nav-item-submenu">
							<a href="<?php echo site_url('warning_letter/');?>" target="" class="nav-link <?php if($active_menu=="termination") { echo "active"; } ?>"><i class="icon-stack2"></i> <span>Warning Letter</span></a>
						</li>
						<li class="nav-item nav-item-submenu">
