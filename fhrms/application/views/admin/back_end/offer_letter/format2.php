<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
				...
				<head>
					...
					<style>
					p{font-size:16px !important;margin-bottom:1%;text-align:justify;font-family: 'Open Sans', sans-serif;}
	...
	<body class="body" style="padding:0 !important; margin:0 !important; display:block !important; background:#ffffff; -webkit-text-size-adjust:none">
											...
											<div style="color: #000;font-family: Tahoma;font-size: 17px;line-height: 18px;text-align: justify; padding-left: 0%;">
												...
												<br>
												<p style="font-size:12px;line-height:1.8;"><b>Dear Mr./Mrs./Ms <?php echo $letter_details[0]['emp_name'];?></b><br><br>
												
													<span style="margin-left:0%;">
													Further  to your interview , we  are  pleased  to  inform  you  that  you  are  hereby  appointed  as <b><?php echo $letter_details[0]['designation'];?></b>  in  the  <b><?php echo $letter_details[0]['department'];?></b> Department  of  our associate company  <b><?php echo $letter_details[0]['client_name'];?></b>. You are assigned to work  at <?php echo $letter_details[0]['location'];?> as  per  terms  and  conditions  discussed  and agreed  upon  as  under :-
												</p>
												<p style="font-size:12px;line-height:1.5;margin-left:3% !important;margin-top: 1% !important;">
													<ol type="1" style="font-size:12px;line-height:1.8;">
														  <li>This appointment is effective from <?php echo date("d-m-Y",strtotime($letter_details[0]['joining_date']));?> the date of your joining our Organization.</li>

  <li>Your salary and other allowances shall be as per Annexure-1.</li>
  ...
  <li>During the tenure of your services, you will wholly devote yourself to the work assigned to you and will not undertake any other employment either on full or part time basis without prior permission of the Company in writing.  Any contravention of this condition will entail termination of your services from the Company.</li>
														...
														<li>Your  services  are  liable  to  be  terminated  at  any  time :</li>
...
<li>if you are found to be not possessing desired qualification which do not conform to custom authority and / govt.  regulation as may be required from time to time and  necessary for continuation of business or its exigencies or on account of redundancy.</li>
	...
	<li>You shall carry out the job of _(Current Designation)__ and such other jobs connected with or incidental to which is necessary for business of the Company.  You shall do any other work assigned to you, which you are capable of doing or work at any other post which has been temporarily assigned to you.
	</li>
	<li>You shall faithfully and to the best of your ability perform your duties that may be entrusted to you from time to time by the management.  You will be bound by rules, regulations and orders promulgated by the management in relation to conduct, discipline and policy matters.

</br>You will not seek membership of any local or public bodies without first obtaining specific permission of the management. In the event of your becoming member without following due process as mentioned , it shall amount to contravention of provision of employment condition and the management reserves the right to take appropriate action including dispensing with your services , as it may deem fit. 

</br>You will not give out to any one, by word of mouth or otherwise, particulars of our business or administrative or organizational matters of a confidential nature which may be your privilege to know by virtue of your being our employee.
	</li>
	...
	<li>Any balance of advance or loan taken by you from the Company, shall be fully recovered from your salary and any other legal dues including Gratuity, at the time of you’re leaving the services of the Company. 
</li>
...
<li>All disputes arising out of this letter will be subject to the jurisdiction of the Bangalore Court.  And that the courts, tribunals and/or authorities at Bangalore only shall have jurisdiction to entertain, try and decide such disputes or differences arising out of or pertaining to this contract of employment, irrespective of your working HQ being elsewhere at that times.
												...
												<p style="font-size:12px;line-height:1.8;"><br>
													...
													<span style="margin-left:0%;">
													You  are  requested  to  return  the  enclosed  copy  duly  signed  as  a  token  of  your  acceptance  of  the  terms  and  conditions  of  your  employment.</span><br>
													<span style="margin-left:0%;">
											...
											<div style="color: #000;font-family: Tahoma;font-size: 17px;line-height: 18px;text-align: justify; padding-left: 0%;">
												...
												<center>
													<table class="table table1" border="1" style="border-collapse:collapse;width:70%;margin-bottom:20px;">
															<tbody>
															  <tr>
											...
											<table style="border-collapse:collapse;width:100%;margin-bottom:20px;">
															<tbody>
															  <tr>
																<td colspan="3" style="font-size:12px;text-align:left;padding:7px">
																	<p >For ;<b>Fretus Folks India Pvt Ltd.</b></p>
														
													<p ><b>Authorized Signatory</b></p>	
																  </td>
																 
																<td style="font-size:12px;text-align:left;padding:7px;width:13%">
																	<p style="line-height:1.8;font-size:14px">	
