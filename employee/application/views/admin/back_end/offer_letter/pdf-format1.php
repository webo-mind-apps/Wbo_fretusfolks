...
<img class="abc-top" src="<?php echo base_url()?>admin_assets/ffi_header.jpg">
   ...
   <img class="abc-bottom" src="<?php echo base_url()?>admin_assets/ffi_footer.jpg">
		<table style="border-collapse:collapse;width:100%;margin-bottom:20px;margin-top:20px;">
         <tbody>
            <tr>
               <td colspan="3" style="font-size:12px;text-align:left;padding:7px">
						<span>Mr. /Mrs. /Ms. : <?php echo $letter_details[0]['emp_name']; ?></span> <br>
               </td>
               <td style="font-size:12px;text-align:right;padding:7px;width:30%;padding-top:-100px;">
						<span>Date : <?php echo date("d-m-Y", strtotime($letter_details[0]['joining_date'])); ?></span> <br>
						</td>
            </tr>
				<tr></tr>
               <td colspan="4" style="font-size:12px;text-align:left;padding:7px">
						<span>Employee ID : <?php echo $letter_details[0]['employee_id']; ?></span> <br>
               </td>
            </tr>
				<tr>
               <td colspan="4" style="font-size:12px;text-align:left;padding:7px">
   ...
   <h1 style="font-size:18px;text-align:center;text-decoration:underline;margin-top:20px">Appointment Letter</h1>
      ...
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
         <span>This appointment is effective from <b><?php echo date("d-M-Y", strtotime($letter_details[0]['joining_date'])); ?></b> the date of your joining our Organization.</span>
      </p>
      </li>
      <li>
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
      ...
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
         ...
         <span>You will be placed on probation for a period of six months and the said period can be extended by another three months and on the expiry of the period of probation or extended period of probation, if you are not confirmed in writing, your services shall be deemed to be automatically terminated. However, unless you are confirmed in writing, you shall not be deemed to be permanent.</span>
      ...
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
         ...
         <span>During probation, the notice period for termination / resignation will be 24 hours from either side. After confirmation, the notice period required from either side is one month.</span>
      ...
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
         ...
         <span>After successful completion of your probation , you will be confirmed in writing as a permanent employee of the Company. You will be entitled to statutory and service benefits and be governed by discipline and other rules existing or may come into existence from time to time , as and when applicable as per rules of the Company and such other benefits as applicable to employees in force from time to time to the location / place wherever you are working.The company depending upon need shall take suitable cover of GPA to take care of liability under Workmen Compensation Act provided you are not covered under ESI Scheme.</span>
      ...
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
         ...
         <span>During the period of service with the company, you shall not indulge and/ or take part in any activity of formation of council and / or association or become a member being part of management staff which are found to be detrimental in the interest of the company in any way. Such an action shall be deemed as infringement to service conditions of the company and amount to causing damage to its interest and shall call for disciplinary action being taken against you, as it may deem fit and appropriate.</span>
      ...
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
         ...
         <span style="font-size:12px;">In the event you are absent from duty without information or permission of leave or you overstay your sanctioned leave, the Management will treat you as having voluntarily abandoned the services of the Company.</span>
      </p>
      ...
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
         <span></span><br>
         <ol type="1">
         <li style="font-size:12px;">During your employment , in case you are found to be medically unfit by the Company’s Authorized Medical practitioner, on examination.</li><br>
         <li style="font-size:12px;">As and when the Company comes to know of any conviction by the Court of Law during the tenure of your service with us or conviction and / or any bad record in the past under the previous employer, or because of your giving false information at the time of your appointment or concealed any material information or given any false details in the application form or otherwise as regard age, education qualification , experience , salary etc.</li><br>
         <li style="font-size:12px;">if you are found to be not possessing desired qualification which do not conform to custom authority and / govt. regulation as may be required from time to time and necessary for continuation of business or its exigencies or on account of redundancy.
         </li>
         </ol>
      </p>
      ...
      <li>
      <p style="font-size:12px;line-height:1.8;text-align:justify;"> 
         <span>You will keep the Company informed of any change in your residential address that may happen during the course of employment of your service with the company.</span>
      </p>

      </li>
      <li>
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
         <span>All documents, plans, drawings, prints, trade secrets, technical information, reports, statements, correspondence etc., written or unwritten and also information and instructions that pass through you or come to your knowledge shall be treated as confidential. You shall not utilize them for your own use or disclose to other persons during or after your employment.</span><br><br>
      ...
      <li>
      <p style="font-size:12px;line-height:1.8;text-align:justify;">
         <span>You shall carry out the job of <b><?php echo $letter_details[0]['designation']; ?></b> and such other jobs connected with or incidental to which is necessary for business of the Company. You shall do any other work assigned to you, which you are capable of doing or work at any other post which has been temporarily assigned to you.</span>
      </p>
      </li>
      <li>
      <p style="font-size:12px;line-height:1.8;text-align:justify">
         <span>You shall faithfully and to the best of your ability perform your duties that may be entrusted to you from time to time by the management. You will be bound by rules, regulations and orders promulgated by the management in relation to conduct, discipline and policy matters.<br><br>
            ...
            You will not give out to any one, by word of mouth or otherwise, particulars of our business or administrative or organizational matters of a confidential nature which may be your privilege to know by virtue of your being our employee.</span>
      </p>
      </li>
      <li>
      <p style="font-size:12px;line-height:1.8;text-align:justify">
         
         <span>While you are in employment of the company, you may be given or handed over company’s property and / or equipment for official use and you shall take care of them including their upkeep. On cessation of employment with the Company, you shall return all documents, books, papers relating to the affairs of the Company, purchased with the Company’s money, which may have come to you, and also any property of the Company in your possession.</span>
      </p>
      </li>
      <li>
      <p style="font-size:12px;line-height:1.8;text-align:justify">
         <span>Any balance of advance or loan taken by you from the Company, shall be fully recovered from your salary and any other legal dues including Gratuity, at the time of you’re leaving the services of the Company. </span>
         ...
         <tbody>
            <tr>
               <td style="font-size:12px;text-align:left;margin-left:-5px;">
                  ...
                  &nbsp;&nbsp;&nbsp;<img src="<?= base_url() ;?>admin_assets/seal.png" style="margin-top:2%;" width="100"><br>
