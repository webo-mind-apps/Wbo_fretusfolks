<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	*/
	...
	<?php
				...
				if(empty($payslip[0]['pay_days']) || $payslip[0]['pay_days']=='null'){$payslip[0]['pay_days']='0';}
				...
				if(empty($payslip[0]['arrear_days']) || $payslip[0]['total_deductions']=='null'){$payslip[0]['arrear_days']='0';}
				?>
    ...
    <div class="container">
		...
		<tbody>
		<tr>
			<td style="width: 50%;">Employee Name : <?php echo $payslip[0]['employee_name'];?></td>
		...
		<tr>
		  <td>Date of Joining : <?php if($payslip[0]['date_of_joining'] !="0000-00-00"){ echo date("d-m-Y",strtotime($payslip[0]['date_of_joining']));}?></td>
		...
		<tr>
			...
			<td>Leave Days : <?php echo $payslip[0]['leave_days'];?></td>
			 <td>Arrears Days : <?php echo $payslip[0]['arrear_days'];?></td> 
		
		</tr>
		<tr>
		  <td>Payable Days : <?php echo $payslip[0]['pay_days'];?></td>
		...
		<tr>
			<td>Basic + DA</td>
			<td><?php echo $payslip[0]['fixed_basic'];?></td>
			<td><?php echo $payslip[0]['earned_basic'];?></td>  
			<td>EPF </td>
		...
		<tr>
		  ...
		  <td><?php echo $payslip[0]['earned_hra'];?></td>  
		  <td>ESIC</td>
		...
		<tr>
		  ...
		  <td><?php echo $payslip[0]['fixed_con_allow'];?></td>
		  <td><?php echo $payslip[0]['earned_con_allow'];?></td>  
		  <td>PT</td>
		...
		<tr>
		  ...
		  <td><?php echo $payslip[0]['fixed_edu_allowance'];?></td>
		  <td><?php echo $payslip[0]['earned_education_allowance'];?></td>  
		  <td>IT</td>
		...
		<tr>
		  ...
		  <td><?php echo $payslip[0]['fixed_med_reim'];?></td>
		  <td><?php echo $payslip[0]['earned_med_reim'];?></td>  
		   <td>LWF</td>
		  <td><?php echo $payslip[0]['lwf'];?></td> 
		</tr>
		<tr>
		  <td>Special Allowance</td>
		  <td><?php echo $payslip[0]['fixed_spec_allow'];?></td>
		  <td><?php echo $payslip[0]['earned_spec_allow'];?></td>  
		...
		<tr>
		  ...
		  <td><?php echo $payslip[0]['fixed_oth_allow'];?></td>
		  <td><?php echo $payslip[0]['earned_oth_allow'];?></td>  
		...
		<tr>
		  ...
		  <td><?php echo $payslip[0]['earned_st_bonus'];?></td>  
		  <td></td>
		  <td></td>
		...
		<tr>
		  <td>Leave Wages</td>
		  <td><?php echo $payslip[0]['fixed_leave_wages'];?></td>
		  <td><?php echo $payslip[0]['earned_leave_wages'];?></td>  
		  <td></td>
		  <td></td>
		...
		<tr>
		  <td>Holiday Wages</td>
		  <td><?php echo $payslip[0]['fixed_holidays_wages'];?></td>
		  <td><?php echo $payslip[0]['earned_holiday_wages'];?></td>  
		  <td></td>
		  <td></td>
		...
		<tr>
		  ...
		  <td><?php echo $payslip[0]['earned_attendance_bonus'];?></td>  
		  <td></td>
		  <td></td>
		...
		<tr>
		  ...
		  <td><?php echo $payslip[0]['earned_ot_wages'];?></td>  
		  <td></td>
		  <td></td>
		...
		<tr>
		  <td>Incentive </td>
		  <td><?php echo $payslip[0]['fixed_incentive'];?></td>
		  <td><?php echo $payslip[0]['earned_incentive'];?></td>  
		  <td></td>
		  <td></td>
		...
		<tr>
		  <td>Arrear Wages </td>
		  <td><?php echo $payslip[0]['fixed_arrear_wages'];?></td>
		  <td><?php echo $payslip[0]['earned_arrear_wages'];?></td>  
		  <td></td>
		  <td></td>
		...
		<tr>
		  ...
		  <td><?php echo $payslip[0]['earned_other_wages'];?></td>  
		  <td></td>
		  <td></td>
		...
		<tr style="border-top: 2px solid;">
			...
			<th style="width: 134px;"><?php echo $payslip[0]['fixed_gross'];?></th>
			<th style="width: 151px;"><?php echo $payslip[0]['earned_gross'];?></th>  
			<th>Total Deduction </th>
			<th style="width: 13%;"><?php echo $payslip[0]['total_deductions'];?></th>
		</tr>
		</tbody>
	</table>
<table style=" margin-top: 3px;">
