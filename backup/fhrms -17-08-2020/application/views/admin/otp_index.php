							...
							?>	
								<?php
									...
									<div class="alert bg-green alert-styled-left" >
										<button type="button" class="close" data-dismiss="alert"></button>
										<span class="text-semibold" class="flash" style="color:white;"><?php echo $this->session->tempdata('success'); ?></span>
									</div>
									<?php 
									}
								?>	
								<div class="form-group form-group-feedback form-group-feedback-left">
									<input type="text" maxlength="6" class="form-control" placeholder="Enter OTP" name="cxfdfdsfdfs" id="otp" required>
								...
								<a  class="reset_pass" href="<?php echo base_url().'home/resend_otp'; ?>">Resend OTP?</a>
									<button type="submit" name="submit" class="btn btn-primary btn-block" style="margin-top:10px;">Sign in</button>
								</div>
