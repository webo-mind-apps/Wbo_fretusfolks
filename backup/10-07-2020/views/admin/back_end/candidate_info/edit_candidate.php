			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
					 ...
					 <form class="form-horizontal" action="<?php echo site_url('candidate_system/update_candidate/'.$candidate[0]['id']);?>" method="POST" enctype="multipart/form-data">
							...
							<div class="card-body">
								<div class="row">
											...
											<label>Enter Client Name: <span class="text-danger">*</span></label>
												<select class="form-control select-search" name="client" id="client" required data-fouc>
													...
													<?php
														...
														{
															if($res['id']==$candidate[0]['client_id'])
															{
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="emp_name" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$" id="emp_name" value="<?php echo $candidate[0]['emp_name'];?>" autocomplete="off" required>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="phone" id="phone" onkeypress="return isNumber(event)" value="<?php echo $candidate[0]['phone1'];?>" maxlength="10" autocomplete="off" required>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										...
										<div class="input-group">
											<input type="text" class="form-control" name="email" id="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" value="<?php echo $candidate[0]['email'];?>" autocomplete="off" required>
										</div>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-group">
												<input type="text" class="form-control" name="location" id="location" value="<?php echo $candidate[0]['location'];?>" autocomplete="off" required>
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control datepicker" name="interview_date" id="interview_date" value="<?php echo date("d-m-Y",strtotime($candidate[0]['interview_date']));?>" required placeholder="Date of Interview" autocomplete="off">
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control datepicker" name="joining_date" id="joining_date" value="<?php echo date("d-m-Y",strtotime($candidate[0]['joining_date']));?>" placeholder="Date of Joining " autocomplete="off">
											</div>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="aadhar_no" id="aadhar_no"  onkeypress="return isNumber(event)" maxlength="12"value="<?php echo $candidate[0]['aadhar_no'];?>" autocomplete="off" required>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label>Attach Adhaar Card:</label>
											<input type="file" id="file" name="file_aadhar" class="form-input-styled" data-fouc onchange="validate_file(this.id)">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="driving_license" id="driving_license" value="<?php echo $candidate[0]['driving_license_no'];?>" autocomplete="off" >
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label>Photo:</label>
											<input type="file" id="photo" name="photo" class="form-input-styled" data-fouc onchange="validate_file(this.id)">
											<span class="form-text text-muted">Max file size 5 Mb</span>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label>Resume:</label>
											<input type="file" id="resume" name="resume" class="form-input-styled" data-fouc onchange="validate_file(this.id)">
											<span class="form-text text-muted">Max file size 5 Mb</span>
										</div>
									</div>
								</div>
