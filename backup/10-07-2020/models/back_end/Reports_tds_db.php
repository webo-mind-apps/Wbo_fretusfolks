...
class Reports_tds_db extends CI_Model 
{  
	...
	function search_tds_details()
	{
		...
		$this->db->select("a.*,d.invoice_no,d.service_location,b.client_name,c.state_name,e.code");
		...
		if($tds_code !="")
		{
			$this->db->where('a.tds_code',$tds_code);
		}
