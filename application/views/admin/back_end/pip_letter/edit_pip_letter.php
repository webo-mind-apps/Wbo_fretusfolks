		...
		function get_emp_details()
		{
			...
			if(emp_id!="")
			{
				 $("div#divLoading").addClass('show');	
					jQuery.ajax({
					type:"POST",
					url:"<?php echo base_url(); ?>" + "index.php/pip_letter/get_emp_details",
					datatype:"text",
					data:{emp_id:emp_id},
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="<?php echo site_url('pip_letter');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">PIP Letter</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">PIP Letter</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
						 <form class="form-horizontal" action="<?php echo site_url('pip_letter/update_letter/'.$pip_info[0]['id']);?>" method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header header-elements-inline">
									<h5 class="card-title">Edit PIP Letter Details</h5>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="from_name" id="from_name" value="<?php echo $pip_info[0]['from_name']?>" autocomplete="off" required>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea id="observation" name="observation" class="form-control form-input-styled editor" data-fouc><?php echo $pip_info[0]['observation'];?></textarea>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea id="goals" name="goals" class="form-control form-input-styled editor" data-fouc><?php echo $pip_info[0]['goals'];?></textarea>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea id="updates" name="updates" class="form-control form-input-styled editor" data-fouc><?php echo $pip_info[0]['updates'];?></textarea>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<textarea id="timeline" name="timeline" class="form-control form-input-styled editor" data-fouc><?php echo $pip_info[0]['timeline'];?></textarea>
