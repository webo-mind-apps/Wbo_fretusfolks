	...
	<?php $this->load->view('admin/back_end/menu'); ?>
		...
		<div class="content-wrapper">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-12">
					 <form class="form-horizontal" action="<?php echo site_url('ffi_assets/update_assets/'.$assets[0]['id']);?>" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="textbox" class="form-control" name="asset_name" id="asset_name" placeholder="Asset Name" autocomplete="off" required data-fouc value="<?php echo $assets[0]['asset_name'];?>">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label>Asset Code: <span class="text-danger">*</span></label>
											<input type="textbox" class="form-control" name="asset_code" id="asset_code" placeholder="Asset Code" autocomplete="off" required data-fouc value="<?php echo $assets[0]['asset_code'];?>">
										</div>
									</div>
								...
								<div class="row">
										...
										<div class="form-group">
											...
											<select class="form-control select-search" name="employee" id="employee" required data-fouc>
												...
												<?php
													...
													{
														if($assets[0]['employee_id']==$res['id'])
														{
															echo '<option value="'.$res['id'].'" selected>'.$res['emp_name'].'</option> ';
														}
														else
														{
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="textbox" class="form-control datepicker" name="issue_date" id="issue_date" placeholder="DD-MM-YYYY" autocomplete="off" required value="<?php if($assets[0]['issued_date']!="0000-00-00"){echo date("d-m-Y",strtotime($assets[0]['issued_date']));}?>" data-fouc>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="textbox" class="form-control datepicker" name="return_date" id="return_date" placeholder="DD-MM-YYYY" autocomplete="off" data-fouc value="<?php if($assets[0]['returned_date']!="0000-00-00"){echo date("d-m-Y",strtotime($assets[0]['returned_date']));}?>">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label>Damage/Recovery: <span class="text-danger">*</span></label>
											<input type="textbox" class="form-control" name="damage" id="damage" autocomplete="off" value="<?php echo $assets[0]['damage_recover'];?>" data-fouc>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<select class="form-control select-search" name="status" id="status" autocomplete="off" required data-fouc>
												...
												<option value="0" <?php if($assets[0]['status']==0){ echo "selected";}?>>Issued</option>
												<option value="1" <?php if($assets[0]['status']==1){ echo "selected";}?>>Returned</option>
											</select>
										</div>
									</div>
								</div>
