		...
		function delete_assets(id)
		{
			...
			if(r==true)
			{
				$("div#divLoading").addClass('show');	
					...
					{
						location.reload();
						$("#ffi_assets_d_table").DataTable().ajax.reload(); 
...
<script>
					var DatatableAdvanced = function() {
						...
						var _componentDatatableAdvanced = function() {
							...
							var dataTable = $('#ffi_assets_d_table').DataTable({
								'processing': true,
								'serverSide': true,
								'order': [],
								'ajax': {
									'url': "<?php echo base_url() . 'Ffi_assets/get_all_data' ?>",
									'type': 'POST'
								},
								'columnDefs': [{
									"targets": [7],
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<table id="ffi_assets_d_table" class="table datatable-basic table-bordered table-striped table-hover">
						<thead>
							<tr>
								<th>Si No</th>
