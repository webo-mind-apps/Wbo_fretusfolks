		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
						 <form class="form-horizontal" action="<?php echo site_url('show_cause/save_letter');?>" method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header header-elements-inline">
									<h5 class="card-title">New Show Cause Letter Details</h5>
