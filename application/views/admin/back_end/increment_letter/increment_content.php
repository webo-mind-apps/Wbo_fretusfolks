			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="<?php echo site_url('increment_letter/');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">Increment Master</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">New Increment Letter Content</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
					 ...
					 <form class="form-horizontal" action="<?php echo site_url('increment_letter/save_increment_letter_content');?>" method="POST" enctype="multipart/form-data">
                        
						<!-- Other inputs -->
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">Increment Letter Content Details</h5>
