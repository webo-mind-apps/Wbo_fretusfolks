...
<head>
	...
	<script>
		...
		<script>
			function delete_ffi_pip_letter(id)
			{
				...
				if(r==true)
				{
					 $("div#divLoading").addClass('show');	
						jQuery.ajax({
						type:"POST",
						url:"<?php echo base_url(); ?>" + "index.php/ffi_pip_letter/delete_ffi_pip_letter",
						datatype:"text",
						data:{id:id},
						success:function(response)
						{
							...
							$("div#divLoading").removeClass('show');
							$("#ffi_pip_letter_d_table").DataTable().ajax.reload(); 
						},
						error:function (xhr, ajaxOptions, thrownError){}
						});
				}
...
<script>
					var DatatableAdvanced = function() {
						...
						var _componentDatatableAdvanced = function() {
							...
							var dataTable = $('#ffi_pip_letter_d_table').DataTable({
								'processing': true,
								'serverSide': true,
								'order': [],
								'ajax': {
									'url': "<?php echo base_url() . 'Ffi_pip_letter/get_all_data' ?>",
									'type': 'POST',
									data: {
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">FFI PIP Letter</span></h4>
						<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
					</div>

					<div class="header-elements d-none">
							<a href="<?php echo site_url('ffi_pip_letter/new_pip_letter');?>" class="btn btn-labeled btn-labeled-right bg-primary">New FFI PIP Letter<b><i class="fa fa-plus" aria-hidden="true"></i></b></a>
					</div>
				</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">FFI PIP Letter Details</h5>
					...
					<table id="ffi_pip_letter_d_table" class="table datatable-basic table-bordered table-striped table-hover">
						<thead>
							<tr>
								<th>Si No</th>
								<th>From</th>
