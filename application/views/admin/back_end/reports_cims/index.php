		...
		function search_cims_details()
		{
			...
			if(client=="" && from_date=="" && to_date=="" && data=="" && state=="" && emp_location=="" && active_status=="")
			{
			 ...
			 $("div#divLoading").addClass('show');	
				jQuery.ajax({
				type:"POST",
				url:"<?php echo base_url(); ?>" + "index.php/reports_cims/search_cims_details",
				datatype:"text",
				data:{client:client,from_date:from_date,to_date:to_date,req_data:req_data,state:state,active_status:active_status,<?php echo $this->security->get_csrf_token_name();?>: '<?php echo $this->security->get_csrf_hash();?>'},
	...
	<div id="divLoading"> 
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">CIMS Reports</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">CIMS Reports</span>
						</div>
			...
			<div class="content">		
				...
				<div class="row">
					<div class="col-md-12">
					 <form class="form-horizontal" id="my_form" action="<?php echo site_url('reports_cims/download_report');?>" method="POST" enctype="multipart/form-data">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<select class="form-control multiselect-select-all" name="data[]" id="data" multiple="multiple" data-fouc>
												...
												<option value="gross_value">Gross Value</option>
												<option value="service_value">Service Value</option>
												<option value="source_value">Source Value</option>
												<option value="total_employee">Total Employee</option>
												...
												<option value="tax_amount">Total Tax Amount</option>
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group" style="margin-top: 27px;">
											<button type="button" class="btn btn-primary btn-labeled btn-labeled-left" onclick="search_cims_details();"><b><i class="fa fa-search" aria-hidden="true" style="font-size: 16px;"></i></b> Search</button>
