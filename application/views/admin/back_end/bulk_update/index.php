			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Bulk Inactive</span></h4>
										...
										<div class="modal-content">
											...
											<div class="content">
												<div class="modal-body">
													<form enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>bulk_update/download_inactive_details" name="certform">
														<label class="down"><b>Clinent Name</b></label>
														<div class="form-group">

															<select name="bulk_inactive_client" class="form-control">
														...
														<label class="down"><b>Date of Leaving</b></label>
														<div class="form-group">
																<input id="From" type="text" name="date_of_leaving" class="form-control" autocomplete="off"><br>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Bulk Inactive</span>
						</div>

						<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
					</div>
					<span style="float:right"><a href="<?php echo base_url() ?>doc-formate-inactive">Download Sample Format</a></span>
				</div>
			</div>
			<!-- /page header -->
					...
					<div class="col-md-12">
						...
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">Bulk Inactive</h5>

							</div>

							<table id="dtable" class="table datatable-basic table-bordered table-striped table-hover cell-border compact stripe datatable-row-basic">
								<thead>
									<tr>
										<th>SI No</th>
										<th>Client Name</th>
