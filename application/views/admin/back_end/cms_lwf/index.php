			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="header-elements d-none">
						<a href="<?php echo site_url('cms_lwf/new_cms_lwf');?>" class="btn btn-labeled btn-labeled-right bg-primary">New LWF Challan<b><i class="fa fa-plus" aria-hidden="true"></i></b></a>
					</div>
				</div>
							...
							<div class="card">
								...
								<div class="card-body">	
										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													<button type="button" class="btn btn-primary btn-labeled btn-labeled-left" onclick="search_lwf();"><b><i class="fa fa-search" aria-hidden="true" style="font-size: 16px;"></i></b> Search</button>
												</div>
											</div>
										</div>	
								</div>
