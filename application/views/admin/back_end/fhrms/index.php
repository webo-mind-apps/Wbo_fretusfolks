					...
					<div class="card-header header-elements-inline">
						...
						<div class="header-elements">
							<div class="list-icons">
		                		<a href="<?php echo site_url('fhrms/download_fhrms');?>"><i class="fa fa-download" aria-hidden="true"></i></a>
													...
													<div class="list-icons">
														<div class="dropdown">
															...
															<div class="dropdown-menu dropdown-menu-right">
																...
																<a href="javascript:void(0);" id="'.$row['id'].'" onclick="delete_fhrms(this.id);" class="dropdown-item"><i class="fa fa-trash"></i> Delete</a>
															</div>
														</div>
													</div>
												</td>
