		...
		function get_emp_details()
		{
			...
			if(emp_id!="")
			{
				 $("div#divLoading").addClass('show');	
					jQuery.ajax({
					type:"POST",
					url:"<?php echo base_url(); ?>" + "index.php/termination_letter/get_emp_details",
					datatype:"text",
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
						 <form class="form-horizontal" action="<?php echo site_url('termination_letter/save_letter');?>" method="POST" enctype="multipart/form-data">
						     
						     <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
						     
							<div class="card">
								<div class="card-header header-elements-inline">
									<h5 class="card-title">New Termination Letter Details</h5>
										 ...
										 <div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-group">
													...
													placeholder="Absent From date" autocomplete="off">
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-group">
													...
													placeholder="Show cause Notice date" autocomplete="off">
												</div>
											</div>
										</div>
									</div>
										 ...
										 <div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-group">
													...
													placeholder="Termination Date" autocomplete="off">
												</div>
											</div>
										</div>
