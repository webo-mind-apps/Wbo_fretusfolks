		...
		function get_emp_details()
		{
			...
			if(emp_id!="")
			{
				 $("div#divLoading").addClass('show');	
					jQuery.ajax({
					type:"POST",
					url:"<?php echo base_url(); ?>" + "index.php/ffi_show_cause/get_emp_details",
					datatype:"text",
					data:{emp_id:emp_id},
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="<?php echo site_url('ffi_show_cause');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">FFI Show Cause Letter</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">FFI Show Cause Letter</span>
						</div>
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
						 <form class="form-horizontal" action="<?php echo site_url('ffi_show_cause/update_letter/'.$pip_info[0]['id']);?>" method="POST" enctype="multipart/form-data">
						     
						     <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
						     
							<div class="card">
								<div class="card-header header-elements-inline">
									<h5 class="card-title">Edit FFI Show Cause Letter Details</h5>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-group">
													...
													placeholder="Try me&hellip;" value="<?php echo date("d-m-Y",strtotime($pip_info[0]['date']));?>" autocomplete="off">
												</div>
											</div>
										</div>
									</div>
