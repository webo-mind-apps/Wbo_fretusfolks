	...
	<script>
		function delete_show_cause_letter(id)
		{
			...
			if(r==true)
			{
				jQuery.ajax({
					type:"POST",
					url:"<?php echo base_url(); ?>" + "index.php/ffi_show_cause/delete_show_cause_letter",
					datatype:"text",
					data:{id:id},
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">FFI Show Cause Letter</span></h4>
						<a href="#" class="header-elements-toggle text-default d-md-none"><i class="icon-more"></i></a>
					</div>

					<div class="header-elements d-none">
							<a href="<?php echo site_url('ffi_show_cause/new_show_cause');?>" class="btn btn-labeled btn-labeled-right bg-primary">New FFI Show Cause Letter<b><i class="fa fa-plus" aria-hidden="true"></i></b></a>
					</div>
				</div>
			...
			<div class="content">
				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h5 class="card-title">FFI Show Cause Letter Details</h5>
					...
					var DatatableAdvanced = function() {
						...
						var _componentDatatableAdvanced = function() {
							...
							var dataTable = $('#dtable').DataTable({
								...
								'order': [], 
								'ajax': {
									'url': "<?php echo base_url() . 'ffi_show_cause/get_all_data' ?>",
									'type': 'POST'
								},
								'columnDefs': [{
									"targets": [6],
