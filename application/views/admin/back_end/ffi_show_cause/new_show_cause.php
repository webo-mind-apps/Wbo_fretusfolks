		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="row">
					...
					<div class="col-md-12">
						 <form class="form-horizontal" action="<?php echo site_url('ffi_show_cause/save_letter');?>" method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header header-elements-inline">
									<h5 class="card-title">New FFI Show Cause Letter Details</h5>
