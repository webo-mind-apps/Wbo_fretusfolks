...
<body onload="window.print();">
   ...
   <div style="margin:100px 35px 0">
      ...
      <p>You are requested to bring the following documents at the time of joining:</p>
      ...
      <div style="color: #000;font-family: Tahoma;font-size: 10px;line-height: 1.5px;text-align: justify; padding-left: 0%;">
         ...
         <p style="line-height:1.8;font-size:14px ;">
            <span style="margin-left:10%;text-decoration:underline;">
               Compensation Sheet <br>
            </span>
            <span style="margin-left:10%;">Offer No : <?php echo $letter_details[0]['ffi_emp_id']; ?> <br></span>
         ...
         <center>
            ...
            <table class="table table1" cellpadding="6" border="1" style="border-collapse:collapse;width:100%;margin-bottom:5px;">
               <tbody>
                  <tr>
         ...
         <p style="margin-top:40px;font-size:13px"><b>Signature</b></p> <br /> <br />
         <p style="font-size:12px"><b>Name:</b><?php echo $letter_details[0]['emp_name']; ?></p>
