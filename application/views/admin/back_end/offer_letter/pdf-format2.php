...
<body onload="window.print();" class="body" style="padding:0 !important; margin:0 !important; display:block !important; background:#ffffff; -webkit-text-size-adjust:none">
  ...
  <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:8.2%;"> -->
  ...
  <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:20.8%;margin-bottom:0;padding-bottom:0"> -->
         ...
         <tr>
            <td style="padding-left:5%;padding-right:5%;">
               <div style="color: #000;font-family: Tahoma;font-size: 17px;line-height: 18px;text-align: justify; padding-left: 0%;margin-left: 0%;">
                  <!-- <img style="padding-left: 0%;" src="admin_assets/ffi_header.jpg"> -->
                  <br><br> 
   ...
   <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:34%;"> -->
  ...
  <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:29.2%;"> -->
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody>
         <tr>
            <td style="padding-left:5%;padding-right:5%;">
                  ...
                  <center>
                     ...
                     <table class="table table1" border="1" style="border-collapse:collapse;width:80%;margin-bottom:5px;">
                        <tbody>
                           ...
                           <tr>
                               <td style="font-size:12px;">Employee PF @ 12%</td>
                           ...
                           <tr>
                               <td style="font-size:12px;">Employee ESIC PF @ 1.75%</td>
                           ...
                           <tr>
                               <td style="font-size:12px;">Employer PF 13%</td>
                           ...
                           <tr>
                               <td style="font-size:12px;">Employer ESIC @ 4.75%</td>
   ...
   <br><br>
  <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:-2.5%;"> -->
   <br>
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody>
         <tr>
  ...
  <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:5.8%;"> -->
