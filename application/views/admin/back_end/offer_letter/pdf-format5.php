...
<body>
    <div style="margin:0px 35">
        ...
        <p style="text-align:right;">Date : <b
                style="font-weight:bold;"><?= date("d-M-Y",strtotime($letter_details[0]['joining_date'])); ?></b></p>
        ...
        <p style="font-size:12.7px;line-height:1.5;text-align:justify;">
            We are pleased to offer you employment to work as <?= $letter_details[0]['designation']; ?> as on
            <?= date("d-M-Y",strtotime($letter_details[0]['joining_date'])); ?> on deputation with our client/s, <b
                style="font-weight:bold;"><?= ucwords($letter_details[0]['client_name']); ?></b>. for a fixed period of
            ...
            <li>
                <p style="font-size:12px;line-height:1.5;text-align:justify;">
                    ...
                    if you are found guilty of activities such <b style="font-weight:bold;">as Cash mismanagement,
                        ...
                        <?= ucwords($letter_details[0]['client_name']); ?> and other delivery associate, irregularity at
        ...
        <ol start="8">
            ...
            <li>
                <p style="font-size:12px;line-height:1.5;text-align:justify;">
                    ...
                    <?= ucwords($letter_details[0]['client_name']); ?>. (to which you have been deputed).
                </p>
            </li>
            <li>
                <p style="font-size:12px;line-height:1.5;text-align:justify;">
                    This contract shall be terminable by either party giving <?=$letter_details[0]['notice_period'];?>
                ...
                <tr>
                    <td colspan="3" style="font-size:14px;text-align:left;">
                        <p style="line-height:1.8;">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="admin_assets/seal.png" style=""
                                width="100"><br>
            ...
            <tbody>
                <tr>
                    ...
                    <td colspan="3" style="font-size:14px;text-align:left;">
                        <p style="line-height:1.8;">
                            Name : <b
                                style="font-weight:bold;"><?= ucwords($letter_details[0]['emp_name']); ?></b><br /><br /><br /><br />
                            Signature:
                        </p>
                    </td>
                </tr>
