...
<body onload="window.print();">
   ...
   <div style="position: absolute;
      ...
      <p style="line-height:1.8;font-size:14px;font-family:times; ">
         <li>Date : <?php echo date("d-m-Y", strtotime($letter_details[0]['joining_date'])); ?></li> <br>
      </p>
   </div>

   <div style="margin:0 35px">
      <p style="line-height:1.8;font-size:14px;font-family:times;">
         <li>Mr. /Mrs. /Ms. : <?php echo $letter_details[0]['emp_name']; ?></li> <br>
         <li>Employee ID : <?php echo $letter_details[0]['ffi_emp_id']; ?></li> <br>
         <li>Place : <?php echo $letter_details[0]['location']; ?></li> <br>
      </p>
   </div>
   ...
   <div style="margin:0 35px">
      ...
      <ol style="font-size:12px;line-height:1.5;text-align:justify;margin-bottom:100px;">
         <li>
            ...
            <tr>
               <td>
                  <p style="font-size:12px;line-height:1.5;text-align:justify"><br>
                     <li>
                        You are requested to return the enclosed copy duly signed as a token of your acceptance of the terms and conditions of your employment.</li><br><br>
                     <li>
