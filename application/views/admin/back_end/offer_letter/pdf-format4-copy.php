...
<body onload="window.print();" class="body" style="padding:0 !important; margin:0 !important; display:block !important; background:#ffffff; -webkit-text-size-adjust:none">
                        ...
                        <table style="border-collapse:collapse;width:100%;">
                           <tbody>
                              <tr>
                                 ...
                                 <td style="font-size:12px;text-align:left;width:30%">
                                    <p style="line-height:1.8;font-size:14px">
               ...
               <div style="color: #000;font-family: Tahoma;font-size: 17px;line-height: 15px;text-align: justify; padding-left: 0%;">
                  ...
                  <p style="font-size:12px;line-height:1.5;"><b>Dear Mr./Mrs./Ms <?php echo $letter_details[0]['emp_name']; ?></b><br>
                     <span style="margin-left:0%;">
                        Further to your interview , we are pleased to inform you that you are hereby appointed as <b><?php echo $letter_details[0]['designation']; ?></b> in the <b><?php echo $letter_details[0]['department']; ?></b> Department of our associate company <b><?php echo $letter_details[0]['client_name']; ?></b>. You are assigned to work at Bangalore as per terms and conditions discussed and agreed upon as <br>under :-</span><br>
                  </p>
                  <br>
                  <p style="font-size:12px;line-height:1.5;margin-left:3% !important;margin-top: 1% !important;">
                     <ol type="1" style="font-size:12px;line-height:1.5;">
                        <li>This appointment is effective from <b><?php echo date("d-m-Y", strtotime($letter_details[0]['joining_date'])); ?></b> the date of your joining our Organization.</li><br>
                        <li>Your salary and other allowances shall be as per <b>Annexure-1</b>.</li><br>
                        ...
                        <li>In the event you are absent from duty without information or permission of leave or you overstay your sanctioned leave, the Management will treat you as having voluntarily abandoned the services of the Company.</li><br>


                        <li>You will keep the Company informed of any change in your residential address that may happen during the course of employment of your service with the company.</li><br>
   ...
   <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:12%;> -->
         ...
         <tr>
            <td style="padding-left:5%;padding-right:5%;">
               <div style="color: #000;font-family: Tahoma;font-size: 17px;line-height: 18px;text-align: justify; padding-left: 0%;margin-top:-5%">
                  <!-- <img src="admin_assets/ffi_header.jpg"> -->
                  <br><br><br>   
                  <ol type="1" start="10" style="font-size:12px;line-height:1.8;">
                     <li>
                        Your services are liable to be terminated at any time :
                        <ol type="i">
                        <br> <li>During your employment , in case you are found to be medically unfit by the Company’s Authorized Medical practitioner, on examination;</li><br>
   ...
   <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:15.3%"> -->
            ...
            <td style="padding-left:5%;padding-right:5%;">
               <div style="color: #000;font-family: Tahoma;font-size: 17px;line-height: 18px;text-align: justify; padding-left: 0%;">
                  ...
                  <p style="font-size:12px;line-height:1.8;"><br>
                     ...
                     <span style="margin-left:0%;">
                        Hope that this will be the beginning of a long and successful career with us.</span><br><br><br><br><br>
                  </p>
               </div>
            </td>
         </tr>
   ...
   <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:8%;"> -->
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tbody>
         <tr>
            <td style="padding-left:5%;padding-right:5%;">
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-left: 13%;">
      <tbody>
         <tr>
            <td colspan="3" style="font-size:12px;text-align:left;padding:7px">
   ...
   <!-- <img class="abc" src="admin_assets/ffi_footer.jpg" style="margin-top:24.2%"> -->
</body>
