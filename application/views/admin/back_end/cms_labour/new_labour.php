						 ...
						 <form class="form-horizontal" id="my_form" action="<?php echo site_url('cms_labour/save_labour');?>" method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header header-elements-inline">
									<h5 class="card-title">New CMS Labour Notice</h5>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="location" id="location" required class="form-control" autocomplete="off">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Notice Received Date: <span class="text-danger">*</span></label>
													<input type="text" name="received_date" id="received_date" required class="form-control datepicker" autocomplete="off">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="file" name="file" id="file" required class="form-control" autocomplete="off">
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="closure_date" id="closure_date" class="form-control datepicker" autocomplete="off">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
