			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="header-elements d-none">
						<a href="<?php echo site_url('cms_labour/new_cms_labour');?>" class="btn btn-labeled btn-labeled-right bg-primary">New Labour Notice<b><i class="fa fa-plus" aria-hidden="true"></i></b></a>
					</div>
				</div>
						 ...
						 <form class="form-horizontal" id="my_form" action="<?php echo site_url('cms_labour/save_labour');?>" method="POST" enctype="multipart/form-data">
							...
							<div class="card">
								<div class="card-header header-elements-inline">
									<h5 class="card-title">CMS Labour Notice</h5>
								...
								<div class="card-body">	
										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													<button type="button" class="btn btn-primary btn-labeled btn-labeled-left" onclick="search_cms_labour();"><b><i class="fa fa-search" aria-hidden="true" style="font-size: 16px;"></i></b> Search</button>
												</div>
											</div>
										</div>	
								</div>
								<div class="card" id="payslip_table" style="display:none">
									<div class="card-header header-elements-inline">
										<h5 class="card-title">Labour Notice Details</h5>
										<div class="header-elements">
											<div class="list-icons">
												<a class="list-icons-item" data-action="reload"></a>
											</div>
