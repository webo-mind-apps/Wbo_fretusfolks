	...
	<?php $this->load->view('admin/back_end/menu'); ?>
		...
		<div class="content-wrapper">
			...
			<div class="content">
				<div class="row">
					<div class="col-md-12">
					 <form class="form-horizontal" action="<?php echo site_url('fcms/update_invoice/'.$invoice[0]['id']);?>" method="POST" enctype="multipart/form-data">
						<div class="card">
							<div class="card-header header-elements-inline">
								<h5 class="card-title">Edit Invoice Details</h5>
								...
								<div class="row">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<select class="form-control select-search" name="location" id="location" onchange="get_client_gst();" required>
												<option value="">Select Location</option>
												<?php
													foreach($client_location as $res1)
													{
														if($invoice[0]['service_location']==$res1['state'])
														{
															echo '<option value="'.$res1['state'].'" selected>'.$res1['state_name'].'</option> ';
														}
														else
														{
															echo '<option value="'.$res1['state'].'">'.$res1['state_name'].'</option> ';
														}
													}
												?>
											</select>
								...
								<div class="row">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="gst_no" id="gst_no" value="<?php echo $invoice[0]['gst_no'];?>" autocomplete="off" required>
										</div>
									</div>
									<div class="col-md-5">
										<div class="form-group">
											<label>Invoice Number: <span class="text-danger">*</span></label>
											<input type="text" class="form-control" name="invoice_no" id="invoice_no" value="<?php echo $invoice[0]['invoice_no'];?>" autocomplete="off" required>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="gross_value" id="gross_value" onchange="get_calculate_total();" value="<?php echo $invoice[0]['gross_value'];?>" autocomplete="off" required>
										</div>
									</div>
									<div class="col-md-5">
										<div class="form-group">
											<label>Service fees: <span class="text-danger">*</span></label>
											<input type="text" class="form-control" name="service_fees" id="service_fees" onchange="get_calculate_total();" value="<?php echo $invoice[0]['service_value'];?>" autocomplete="off" required>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="source_fees" id="source_fees" onchange="get_calculate_total();" value="<?php echo $invoice[0]['source_value'];?>" autocomplete="off" required>
										</div>
									</div>
									<div class="col-md-5">
										<div class="form-group">
											<label>Total: <span class="text-danger">*</span></label>
											<input type="text" class="form-control" name="total" id="total" onchange="get_calculate_total();" value="<?php echo $invoice[0]['source_value']+$invoice[0]['service_value']+$invoice[0]['gross_value'];?>" autocomplete="off" required>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="cgst" id="cgst" autocomplete="off" onchange="get_tax_amt();" value="<?php echo $invoice[0]['cgst'];?>" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>CGST Amt: <span class="text-danger">*</span></label>
													<input type="text" class="form-control" name="cgst_amt" id="cgst_amt" placeholder="CGST Amt" value="<?php echo $invoice[0]['cgst_amount'];?>" readonly autocomplete="off" required>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="sgst" id="sgst" autocomplete="off" onchange="get_tax_amt();" value="<?php echo $invoice[0]['sgst'];?>" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>SGST Amt: <span class="text-danger">*</span></label>
													<input type="text" class="form-control" name="sgst_amt" id="sgst_amt" placeholder="SGST Amt" value="<?php echo $invoice[0]['sgst_amount'];?>" readonly autocomplete="off" required>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="igst" id="igst" autocomplete="off" onchange="get_tax_amt();" value="<?php echo $invoice[0]['igst'];?>" required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>IGST Amt: <span class="text-danger">*</span></label>
													<input type="text" class="form-control" name="igst_amt" id="igst_amt" placeholder="IGST Amt" value="<?php echo $invoice[0]['igst_amount'];?>" autocomplete="off" readonly required>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" name="total_tax" id="total_tax" value="<?php echo $invoice[0]['tax_amount'];?>" placeholder="Total Tax" autocomplete="off" readonly required>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
													<label>Invoice Amount: <span class="text-danger">*</span></label>
													<input type="text" class="form-control" name="inv_total" id="inv_total" value="<?php echo $invoice[0]['total_value'];?>" placeholder="Grand Total" autocomplete="off" readonly required>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="credit_note" id="credit_note" value="<?php echo $invoice[0]['credit_note'];?>"  onchange="get_grand_total()" autocomplete="off" value="0" required>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label>Debit Note: <span class="text-danger">*</span></label>
											<input type="text" class="form-control" name="debit_note" id="debit_note" value="<?php echo $invoice[0]['debit_note'];?>"  onchange="get_grand_total()" autocomplete="off" value="0" required>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											<label>Grand Total</label>
											<input type="text" class="form-control" name="grand_total" id="grand_total" value="<?php echo $invoice[0]['grand_total'];?>"  placeholder="Grand Total" autocomplete="off" readonly required>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="total_employee" id="total_employee" value="<?php echo $invoice[0]['total_employee'];?>" autocomplete="off" required>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<label>Invoice Date: <span class="text-danger">*</span></label>
											<input type="text" class="form-control datepicker" name="inv_date" id="inv_date" value="<?php echo date("d-m-Y",strtotime($invoice[0]['date']));?>" autocomplete="off" required>
										</div>
									</div>
									<div class="col-md-3">
										<div class="form-group">
											...
											<select class="form-control" name="inv_month" id="inv_month" autocomplete="off" required>
												...
												<?php
													for($i=1;$i<=12;$i++)
													{
														$day=date("F",strtotime("01-".$i."-2018"));
														if($day==$invoice[0]['inv_month'])
														{
