...
<head>
	...
	<script>
		function search_fhrms_details()
		{
			...
			/*
			if(from_date=="" && to_date=="" && data=="" && state=="" && emp_location=="" && active_status=="" && pending_doc=="")
			{
	...
	<div id="divLoading"> 
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">FHRMS Reports</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">FHRMS Reports</span>
						</div>
			...
			<div class="content">		
				...
				<div class="row">
					<div class="col-md-12">
					 <form class="form-horizontal" id="my_form" action="<?php echo site_url('reports_fhrms/download_report');?>" method="POST" enctype="multipart/form-data">
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label>Pending Documents</label>
												<select class="form-control multiselect-select-all" name="pending_doc[]" multiple id="pending_doc" data-fouc>
									...
									<div class="col-md-3" style="margin-top:27px;">
										<div class="form-group">
											<button type="button" class="btn btn-primary btn-labeled btn-labeled-left" onclick="search_fhrms_details();"><b><i class="fa fa-search" aria-hidden="true" style="font-size: 16px;"></i></b> Search</button>
