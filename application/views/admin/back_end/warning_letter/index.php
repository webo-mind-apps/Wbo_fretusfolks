...
<script>
					var DatatableAdvanced = function() {
						...
						var _componentDatatableAdvanced = function() {
							...
							var dataTable = $('#warning_letter_d_table').DataTable({
								'processing': true,
								'serverSide': true,
								'order': [],
								'ajax': {
									'url': "<?php echo base_url() . 'Warning_letter/get_all_data' ?>",
									'type': 'POST',
									data: {
		...
		<div class="content-wrapper">
			...
			<div class="content">
				...
				<div class="card">
					...
					<table id="warning_letter_d_table" class="table datatable-basic table-bordered table-striped table-hover">
						<thead>
							<tr>
								<th>Si No</th>
								<th>Emp ID</th>
