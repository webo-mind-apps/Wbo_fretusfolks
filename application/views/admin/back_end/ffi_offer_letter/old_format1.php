<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<body onload="window.print()" class="body" style="padding:0 !important; margin:0 !important; display:block !important; background:#ffffff; -webkit-text-size-adjust:none">
											...
											<div style="color: #000;font-family: Tahoma;font-size: 17px;line-height: 18px;text-align: justify; padding-left: 0%;">
												<h1 style="font-size:20px;text-align:center;text-decoration: underline;">Appointment Letter</h1>
												
												<br>
												<p style="font-size:12px;line-height:1.8;"><b>Dear Mr./Mrs./Ms <?php echo $letter_details[0]['emp_name'];?></b><br><br>
												
													<span style="margin-left:0%;">
													Further  to your interview , we  are  pleased  to  inform  you  that  you  are  hereby  appointed  as <b><?php echo $letter_details[0]['designation'];?></b>  in  the  <b><?php echo $letter_details[0]['department'];?></b> Department  of  our company  <b>Fretus Folks India Pvt Ltd (FFI)</b>. You are assigned to work  at Bangalore as  per  terms  and  conditions  discussed  and agreed  upon  as  under :-</span>
											...
											<div style="color: #000;font-family: Tahoma;font-size: 17px;line-height: 18px;text-align: justify; padding-left: 0%;">
												...
												<center>
													<table class="table table1" border="1" style="border-collapse:collapse;width:80%;margin-bottom:20px;">
															<tbody>
															  <tr>
