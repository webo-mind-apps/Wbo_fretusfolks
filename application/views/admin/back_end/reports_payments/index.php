		...
		function search_payments_details()
		{
			...
			*/
			 $("div#divLoading").addClass('show');	
				jQuery.ajax({
				type:"POST",
				url:"<?php echo base_url(); ?>" + "index.php/reports_payments/search_payments_details",
				datatype:"text",
	...
	<div id="divLoading"> 
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Payments Reports</span></h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Payments Reports</span>
						</div>
			...
			<div class="content">		
				...
				<div class="row">
					<div class="col-md-12">
					 <form class="form-horizontal" id="my_form" action="<?php echo site_url('reports_payments/download_report');?>" method="POST" enctype="multipart/form-data">
									...
									<div class="col-md-3">
										<div class="form-group">
											<label>State Name</label>
												<select class="form-control multiselect-filtering" name="state[]" id="state" multiple="multiple" data-fouc>
													<?php
													$i=1;
