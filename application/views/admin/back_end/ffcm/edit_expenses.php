	...
	<?php $this->load->view('admin/back_end/menu'); ?>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="<?php echo site_url('ffcm/');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">Fretus Folks Cost Management</span></h4>
			...
			<div class="content">
				...
				<div class="row">
					<div class="col-md-12">
					 <form class="form-horizontal" action="<?php echo site_url('ffcm/update_expenses/'.$expenses[0]['id']);?>" method="POST" enctype="multipart/form-data">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="textbox" class="form-control datepicker" name="exp_date" id="exp_date" placeholder="DD-MM-YYYY" value="<?php if($expenses[0]['date'] !="0000-00-00"){ echo date("d-m-Y",strtotime($expenses[0]['date']));}?>" autocomplete="off" required data-fouc>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											...
											<select class="form-control select-search" name="month" id="month" required data-fouc>
												...
												<option value="January" <?php if($expenses[0]['month']=="January"){ echo "selected";}?>>January</option>
												<option value="February" <?php if($expenses[0]['month']=="February"){ echo "selected";}?>>February</option>
												<option value="March" <?php if($expenses[0]['month']=="March"){ echo "selected";}?>>March</option>
												<option value="April" <?php if($expenses[0]['month']=="April"){ echo "selected";}?>>April</option>
												<option value="May" <?php if($expenses[0]['month']=="May"){ echo "selected";}?>>May</option>
												<option value="June" <?php if($expenses[0]['month']=="June"){ echo "selected";}?>>June</option>
												<option value="July" <?php if($expenses[0]['month']=="July"){ echo "selected";}?>>July</option>
												<option value="August" <?php if($expenses[0]['month']=="August"){ echo "selected";}?>>August</option>
												<option value="September" <?php if($expenses[0]['month']=="September"){ echo "selected";}?>>September</option>
												<option value="October" <?php if($expenses[0]['month']=="October"){ echo "selected";}?>>October</option>
												<option value="November" <?php if($expenses[0]['month']=="November"){ echo "selected";}?>>November</option>
												<option value="December" <?php if($expenses[0]['month']=="December"){ echo "selected";}?>>December</option>
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<label>Nature of Expenses: <span class="text-danger">*</span></label>
											<select class="form-control select-search" name="expenses" id="expenses" required data-fouc>
												<option value="">Select Expenses</option>
												<option value="Fuel" <?php if($expenses[0]['nature_expenses']=="Fuel"){ echo "selected";}?>>Fuel</option>
												<option value="Mobile" <?php if($expenses[0]['nature_expenses']=="Mobile"){ echo "selected";}?>>Mobile</option>
												<option value="Salary" <?php if($expenses[0]['nature_expenses']=="Salary"){ echo "selected";}?>>Salary</option>
												<option value="Conveyance" <?php if($expenses[0]['nature_expenses']=="Conveyance"){ echo "selected";}?>>Conveyance</option>
												<option value="Stationery" <?php if($expenses[0]['nature_expenses']=="Stationery"){ echo "selected";}?>>Stationery</option>
												<option value="Utility" <?php if($expenses[0]['nature_expenses']=="Utility"){ echo "selected";}?>>Utility</option>
												<option value="Others" <?php if($expenses[0]['nature_expenses']=="Others"){ echo "selected";}?>>Others</option>
											</select>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="textbox" class="form-control" name="amount" id="amount" value="<?php echo $expenses[0]['amount'];?>" required data-fouc>
										</div>
									</div>
								</div>
								<div class="row">
