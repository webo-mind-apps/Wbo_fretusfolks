								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="textbox" class="form-control datepicker" name="exp_date" id="exp_date" placeholder="DD-MM-YYYY" autocomplete="off" required data-fouc>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<input type="textbox" class="form-control" name="amount" id="amount" required data-fouc>
										</div>
									</div>
								</div>
								<div class="row">
