		...
		$(document).ready(function()
			{
				...
				$("#addButton").click(function () {
					...
					jQuery.ajax({
								type:"POST",
								url:"<?php echo base_url(); ?>" + "index.php/cms_form_t/add_doc_div",
								datatype:"text",
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><a href="<?php echo site_url('cms_form_t/');?>"><i class="icon-arrow-left52 mr-2"></i></a> <span class="font-weight-semibold">Compliance Management System</span></h4>
						 ...
						 <form class="form-horizontal" id="my_form" action="<?php echo site_url('cms_form_t/save_form_t');?>" method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header header-elements-inline">
									<h5 class="card-title">New CMS Form T Register</h5>
