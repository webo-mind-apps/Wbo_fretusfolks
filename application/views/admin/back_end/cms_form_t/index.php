		...
		function search_form_t()
		{
			...
			if(client=="" && month=="" && year=="")
			{
			 ...
			 $("div#divLoading").addClass('show');	
				jQuery.ajax({
				type:"POST",
				url:"<?php echo base_url(); ?>" + "index.php/cms_form_t/search_cms_form_t",
				datatype:"text",
			...
			if(r==true)
			{
				...
				year=$("#year").val();
				 $("div#divLoading").addClass('show');	
					jQuery.ajax({
					type:"POST",
					url:"<?php echo base_url(); ?>" + "index.php/cms_form_t/delete_form_t",
					datatype:"text",
	...
	<?php $this->load->view('admin/back_end/menu'); ?>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					...
					<div class="header-elements d-none">
						<a href="<?php echo site_url('cms_form_t/new_cms_form_t');?>" class="btn btn-labeled btn-labeled-right bg-primary">New FORM T Register<b><i class="fa fa-plus" aria-hidden="true"></i></b></a>
					</div>
				</div>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<span class="breadcrumb-item active">Compliance Management System FORM T Register</span>
						</div>
			...
			<div class="content">
				<div class="row">
					<div class="col-md-12">
						 <form class="form-horizontal" id="my_form" action="<?php echo site_url('cms_form_t/save_form_t');?>" method="POST" enctype="multipart/form-data">
						     
						     <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
						     
							<div class="card">
								<div class="card-header header-elements-inline">
									<h5 class="card-title">CMS Form T Register</h5>
								...
								<div class="card-body">	
										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													<button type="button" class="btn btn-primary btn-labeled btn-labeled-left" onclick="search_form_t();"><b><i class="fa fa-search" aria-hidden="true" style="font-size: 16px;"></i></b> Search</button>
												</div>
											</div>
										</div>	
								</div>
								<div class="card" id="payslip_table" style="display:none">
									<div class="card-header header-elements-inline">
										<h5 class="card-title">Form T Details</h5>
										<div class="header-elements">
											<div class="list-icons">
												<a class="list-icons-item" data-action="reload"></a>
											</div>
