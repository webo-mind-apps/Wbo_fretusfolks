    ...
    <div class="container">
		...
		<div class="col-md-12" style="border:2px solid #333;">
			<div class="col-md-12">
				...
				<span><h4 style="float:right;text-decoration:none;font-size:12px">Payslip Sep - 2018</h4></span>
			</div>
			<div class="col-md-6">
		...
		<tr>
			...
			<td>Leave Days : <?php echo $payslip[0]['lop_days'];?></td>
		...
		<tr>
		  ...
		  <td>NP Days : <?php echo $payslip[0]['notice_period_days'];?></td>  
		</tr>
