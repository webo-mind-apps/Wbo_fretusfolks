					...
					<div class="right text-center ">
						...
						<div class="col-md-4">
							<div class="header-elements d-none">
								...
								?>
							<a href="<?php echo site_url('offer_letter/pdf_offer_letter/'.$pdf_id);?>" class="btn btn-labeled btn-labeled-right bg-primary">download offer letter <b><i class="fa fa-download" aria-hidden="true"></i></button></b></a>
							</div>	
						</div>
						<div class="col-md-4">
						...
						<a href="<?php echo base_url() ?>admin_assets/exel-formate/ADMS_OFFER_LETTER.xlsx" download >Download Format</a>
